<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"/klwl_web/klwl_pj/hzdy.kailly.com/public/../application/admin/view/limit/time_save.html";i:1564822726;s:73:"/klwl_web/klwl_pj/hzdy.kailly.com/application/admin/view/common/meta.html";i:1552356108;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="layui-form" lay-filter="layuiadmin-form-admin" style="padding: 20px 30px 1px 0;">
            <form action="" class="layui-form">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">限购时段</label>
...
<script>
    ...
    //表单上传
    fromUpload('form',"<?php echo url('Limit/time_save'); ?>");
</script>