<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"/klwl_web/klwl_pj/hzdy.kailly.com/public/../application/admin/view/group/order.html";i:1572602226;s:73:"/klwl_web/klwl_pj/hzdy.kailly.com/application/admin/view/common/meta.html";i:1552356108;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-fluid">
    ...
    <form action="<?php echo url('Group/order_excel'); ?>" method="post">
...
<script>
    layui.use(['table','form','laydate'],function(){
        ...
        var form = layui.form;
        var url = "<?php echo url('Group/order'); ?>";
...
<script type="text/html" id="barDemo">
  <a class="layui-btn layui-btn-xs" lay-event="edit" href="<?php echo url('Group/info'); ?>?id={{d.id}}">查看</a>
  <a class="layui-btn layui-btn-xs open" url="<?php echo url('Group/order_save'); ?>?id={{d.id}}">编辑</a>
    {{# if (d.status=== 1) { }}
  ...
  {{# if(d.status == 2 && d.group_status == 2){ }}
    <a class="layui-btn layui-btn-xs open" width="35%" height="50%" data-title="拼团订单发货" url="<?php echo url('Group/delivery'); ?>?id={{d.id}}">发货</a>
  {{# } }}
...
<script>
    ...
    function closeOrder(id,status,type){
        ...
        get_request("<?php echo url('Group/closeOrder'); ?>",data);
    }
</script>
