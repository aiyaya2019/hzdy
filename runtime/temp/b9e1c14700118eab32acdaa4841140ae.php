                ...
                <div class="layui-col-sm6 layui-col-md12">
                    ...
                    <div class="layui-card layui-fluid">
                        <div class=" layui-fluid" style="display: flex;height: 100%">
                            ...
                            <div class="layui-col-sm2">砍价状态：<?php echo $data['status_name']; ?></div>
                    ...
                    <div class="layui-card">
                        <table class="layui-table" lay-skin="line" style="margin:0">
                            ...
                            <tr>
                                ...
                                <td><?php echo $data['order']['bargain_num']; ?></td>
                                <td>&yen; <?php echo $data['order']['bargain_price']; ?></td>
                                <td>&yen; <?php echo $data['money']; ?></td>
                                <td>
                                <?php if($data['money'] != 0): ?>
                                &yen; <?php echo $data['order']['money']; else: ?>
                                &yen; <?php echo $data['order']['pay_money']; endif; ?>
                                </td>
                            </tr>
                            </tbody>
                        </table>
