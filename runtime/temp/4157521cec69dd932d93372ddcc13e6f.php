			...
			<form action="" class="layui-form">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						...
						<input type="text" name="title" value="<?php echo (isset($data['title']) && ($data['title'] !== '')?$data['title']:''); ?>" lay-verify="required" autocomplete="off" placeholder="请输入广告名称" class="layui-input">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						...
						<input type="text" name="url" value="<?php echo (isset($data['url']) && ($data['url'] !== '')?$data['url']:'#'); ?>" lay-verify="required" autocomplete="off" placeholder="请输入广告跳转链接地址" class="layui-input">
...
<script>
    ...
    fromUpload('form',"<?php echo url('Config/advsave'); ?>");
