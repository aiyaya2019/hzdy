<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"/klwl_web/klwl_pj/hzdy.kailly.com/public/../application/admin/view/user/index.html";i:1572423780;s:73:"/klwl_web/klwl_pj/hzdy.kailly.com/application/admin/view/common/meta.html";i:1552356108;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<form action="<?php echo url('User/explode'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="layui-form-item">
                       ...
                       <div class="layui-inline">
                            <div class="layui-input-block layui-upload">
                                <div type="button" class="layui-btn layui-btn-normal file" id="test1"><i class="layui-icon"></i>选择文件</div>
                                <input class="layui-upload-file" type="file"  name="file" id="test1s">
                                <span class="layui-inline layui-upload-choose">支持 xls、xlsx 格式文件</span>
                            </div>
                        </div>
                       <div class="layui-inline">
                           <button class="layui-btn layui-btn-normal">导入数据</button>
                       </div>
                    </div>
                </div>
...
<script type="text/html" id="barDemo">
  ...
  <a class="layui-btn layui-btn-xs layui-btn-normal open" lay-event="edit" url="<?php echo url('User/point'); ?>?id={{d.id}}">积分明细</a>
   <a class="layui-btn layui-btn-xs layui-btn-normal open" lay-event="edit" url="<?php echo url('User/sign'); ?>?id={{d.id}}">签到记录</a>
   <a class="layui-btn layui-btn-xs layui-btn-normal open" lay-event="edit" url="<?php echo url('User/coupon'); ?>?id={{d.id}}">持有的优惠券</a>
</script>