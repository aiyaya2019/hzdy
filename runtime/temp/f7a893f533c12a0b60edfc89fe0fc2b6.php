<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"/klwl_web/klwl_pj/hzdy.kailly.com/public/../application/admin/view/spike/order_save.html";i:1572601251;s:73:"/klwl_web/klwl_pj/hzdy.kailly.com/application/admin/view/common/meta.html";i:1552356108;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="layui-form" lay-filter="layuiadmin-form-admin" style="padding: 20px 30px 1px 0;">
            ...
            <form action="" class="layui-form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="remark" value="<?php echo $data['remark']; ?>" lay-verify="required" autocomplete="off" placeholder="请输入订单备注" class="layui-input">
                    </div>
                </div>
...
<script>
    ...
    fromUpload('form',"<?php echo url('Spike/order_save'); ?>");
