<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"/klwl_web/klwl_pj/hzdy.kailly.com/public/../application/admin/view/order/delivery.html";i:1571133793;s:73:"/klwl_web/klwl_pj/hzdy.kailly.com/application/admin/view/common/meta.html";i:1552356108;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<script>
    ...
    // 表单提交
    fromUpload('form',"<?php echo url('Order/delivery'); ?>",function(data){
        if(data.code == 200){
