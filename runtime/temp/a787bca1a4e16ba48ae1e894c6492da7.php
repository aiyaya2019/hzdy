<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"/klwl_web/klwl_pj/hzdy.kailly.com/public/../application/admin/view/goods/type_save.html";i:1570689409;s:73:"/klwl_web/klwl_pj/hzdy.kailly.com/application/admin/view/common/meta.html";i:1552356108;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <form action="" class="layui-form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="title" value="<?php echo $type['title']; ?>" lay-verify="required" autocomplete="off" placeholder="请输入内容" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                 ...
                 <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="sort" value="<?php echo $type['sort']; ?>" lay-verify="required" autocomplete="off" placeholder="请输入内容" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
...
<script>
    ...
    //表单上传
    fromUpload('form',"<?php echo url('Goods/type_save'); ?>");
</script>