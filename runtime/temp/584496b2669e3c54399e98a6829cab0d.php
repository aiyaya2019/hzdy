                    ...
                    <div class="layui-card">
                        <table class="layui-table" lay-skin="line" style="margin:0">
                            ...
                            <tr>
                                ...
                                <td><?php echo $data['order']['discount']; ?></td>
                                <td>&yen; <?php echo $data['order']['fare_price']; ?></td>
