			...
			<form action="" class="layui-form">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						...
						<input type="text" name="today" value="<?php echo $data['today']; ?>" lay-verify="required" autocomplete="off" placeholder="请输入连续签到天数" class="layui-input">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						...
						<input type="text" name="point" value="<?php echo $data['point']; ?>" lay-verify="required" autocomplete="off" placeholder="请输入奖励积分" class="layui-input">
...
<script>
    ...
    fromUpload('form',"<?php echo url('Config/sign_save'); ?>");
