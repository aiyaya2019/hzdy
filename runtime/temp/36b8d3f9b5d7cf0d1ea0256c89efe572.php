<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"/klwl_web/klwl_pj/hzdy.kailly.com/public/../application/admin/view/spike/refund.html";i:1572341470;s:73:"/klwl_web/klwl_pj/hzdy.kailly.com/application/admin/view/common/meta.html";i:1552356108;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<script>
    layui.use(['table','form'],function(){
        ...
        var form = layui.form;
        var url = "<?php echo url('Spike/refund'); ?>";
        ...
        table.render({
            ...
            cols:[[
               ...
               {field:'type_name',width:'11%',title:'退款原因'},
                {field:'msg',width:'11%',title:'退款说明'},
    ...
    function refund(id,order_id,status) {
        ...
        layer.confirm(msg, {icon: 3, title:'是否操作'}, function(index) {
            $.ajax({
                url:"<?php echo url('Spike/refundAudit'); ?>",
                type:'post',
...
<a class="layui-btn layui-btn-xs" lay-event="edit" href="<?php echo url('Spike/refund_info'); ?>?id={{d.id}}">订单详情</a>
  {{# if(d.status == 0){ }}
