<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"/klwl_web/klwl_pj/hzdy.kailly.com/public/../application/admin/view/point/order.html";i:1572601392;s:73:"/klwl_web/klwl_pj/hzdy.kailly.com/application/admin/view/common/meta.html";i:1552356108;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="layui-fluid">
    ...
    <form action="<?php echo url('Point/order_excel'); ?>" method="post">
...
<script>
    layui.use(['table','form','laydate'],function(){
        ...
        var form = layui.form;
        var url = "<?php echo url('Point/order'); ?>";
...
<script type="text/html" id="barDemo">
  ...
  <a class="layui-btn layui-btn-xs open" url="<?php echo url('Point/order_save'); ?>?id={{d.id}}">编辑</a>
  
  {{# if(d.status == 1){ }}
  <a class="layui-btn layui-btn-xs open" width="35%" height="50%" data-title="砍价订单发货" url="<?php echo url('Point/delivery'); ?>?id={{d.id}}">发货</a>
  <div class="layui-btn layui-btn-sm" onclick="closeOrder('{{d.id}}', 3)">关闭订单</div>
  {{# } }}
...
<script type="text/javascript">
    function closeOrder(id,status){
        ...
        get_request("<?php echo url('Point/closeOrder'); ?>",data);
    }
</script>
