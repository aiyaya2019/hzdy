<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:92:"/klwl_web/klwl_pj/hzdy.kailly.com/public/../application/admin/view/order/logistics_save.html";i:1562334437;s:73:"/klwl_web/klwl_pj/hzdy.kailly.com/application/admin/view/common/meta.html";i:1552356108;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <form action="" class="layui-form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="name" value="<?php echo $data['name']; ?>" lay-verify="required" autocomplete="off" placeholder="请输入物流公司" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">物流公司编码</label>
                    <div class="layui-input-block">
                        <input type="text" name="code" value="<?php echo $data['code']; ?>" lay-verify="required" autocomplete="off" placeholder="请输入物流公司编码" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
...
<script>
    ...
    //表单上传
    fromUpload('form',"<?php echo url('Order/logistics_save'); ?>");
</script>