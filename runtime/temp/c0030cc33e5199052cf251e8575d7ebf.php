            ...
            <form action="" class="layui-form">
                ...
                <div class="layui-form-item">
                 ...
                 <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="discount" value="<?php echo $goods['discount']; ?>" lay-verify="required|number"  autocomplete="off" placeholder="请输入内容" class="layui-input">
                    </div>
                </div>
...
<script>
    ...
    //表单上传
    fromUpload('form',"<?php echo url('Limit/save'); ?>");
