<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"/klwl_web/klwl_pj/hzdy.kailly.com/public/../application/admin/view/config/banner.html";i:1561967890;s:73:"/klwl_web/klwl_pj/hzdy.kailly.com/application/admin/view/common/meta.html";i:1552356108;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<script>
    layui.use(['table','form','layer'],function(){
        ...
        var url = "<?php echo url('Config/banner'); ?>";
...
<script type="text/html" id="barDemo">
    <a class="layui-btn layui-btn-xs" lay-event="edit" href="<?php echo url('Config/save'); ?>?id={{d.id}}">编辑</a>
    <a class="layui-btn layui-btn-danger layui-btn-xs delete" data-table="banner" data-id="{{d.id}}" lay-event="del">删除</a>
</script>

<script type="text/html" id="add">
    <a class="layui-btn layui-btn-xs" lay-event="edit" href="<?php echo url('Config/save'); ?>">发布轮播图</a>
</script>
