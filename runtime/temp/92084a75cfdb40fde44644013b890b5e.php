<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"/klwl_web/klwl_pj/hzdy.kailly.com/public/../application/admin/view/goods/no_show.html";i:1572254461;s:73:"/klwl_web/klwl_pj/hzdy.kailly.com/application/admin/view/common/meta.html";i:1552356108;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">下架商品</div>
...
<script>
    layui.use(['table','form'],function(){
        ...
        var form = layui.form;
        var url = "<?php echo url('Goods/noShow'); ?>";
...
<script type="text/html" id="barDemo">
  ...
  <a class="layui-btn layui-btn-xs open" url="<?php echo url('Goods/evaluate_save'); ?>?id={{d.id}}">评价</a>
</script>
