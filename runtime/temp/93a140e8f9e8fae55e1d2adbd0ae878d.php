<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"/klwl_web/klwl_pj/hzdy.kailly.com/public/../application/admin/view/order/logistics.html";i:1568621484;s:73:"/klwl_web/klwl_pj/hzdy.kailly.com/application/admin/view/common/meta.html";i:1552356108;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<script>
    layui.use(['table','form'],function(){
        ...
        var form = layui.form;
        var url = "<?php echo url('Order/logistics'); ?>";
...
<script type="text/html" id="barDemo">
  <a class="layui-btn layui-btn-xs" lay-event="edit" href="<?php echo url('Order/logistics_save'); ?>?id={{d.id}}">编辑</a>
...
<script type="text/html" id="add">
    <a class="layui-btn layui-btn-xs" lay-event="edit" href="<?php echo url('Order/logistics_save'); ?>">添加物流公司</a>
</script>
