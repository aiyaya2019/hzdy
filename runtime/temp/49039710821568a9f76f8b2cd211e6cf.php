        ...
        <div class="layui-form" lay-filter="layuiadmin-form-admin" style="padding: 20px 30px 1px 0;">
            <form action="" class="layui-form">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">生日优惠</label>
                    <div class="layui-input-block">
                        <textarea placeholder="请输入生日优惠" lay-verify="required" name="birthday" class="layui-textarea edit"><?php echo $list['birthday']; ?></textarea>
                    </div>
                </div>
...
<script>
    //表单上传
    fromUpload('form',"<?php echo url('User/birthday'); ?>");
