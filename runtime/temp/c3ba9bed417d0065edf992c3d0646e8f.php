        ...
        <div class="layui-form" lay-filter="layuiadmin-form-admin" style="padding: 20px 30px 1px 0;">
            <form action="" class="layui-form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="price" value="<?php echo $goods['price']; ?>" lay-verify="required"  autocomplete="off" placeholder="请输入内容" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="old_price" value="<?php echo $goods['old_price']; ?>" lay-verify="required"  autocomplete="off" placeholder="请输入内容" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="min_price" value="<?php echo $goods['min_price']; ?>" lay-verify="required"  autocomplete="off" placeholder="请输入内容" class="layui-input">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="min_money" value="<?php echo (isset($goods['min_money']) && ($goods['min_money'] !== '')?$goods['min_money']:'0'); ?>" lay-verify="required"  autocomplete="off" placeholder="请输入内容" class="layui-input">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="max_money" value="<?php echo (isset($goods['max_money']) && ($goods['max_money'] !== '')?$goods['max_money']:'0'); ?>" lay-verify="required"  autocomplete="off" placeholder="请输入内容" class="layui-input">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="hour" value="<?php echo $goods['hour']; ?>" required="" lay-verify="required|number" placeholder="小时" autocomplete="off" class="layui-input">
                    </div>
                    <div class="layui-input-inline">
                        <input type="text" name="minute" value="<?php echo $goods['minute']; ?>" required="" lay-verify="required|number" placeholder="分钟" autocomplete="off" class="layui-input">
                    </div>
...
<script>
    ...
    //表单上传
    fromUpload('form',"<?php echo url('Bargain/save'); ?>");
