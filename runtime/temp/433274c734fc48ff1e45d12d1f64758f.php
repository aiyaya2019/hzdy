    ...
    <div class="layui-card">
        ...
        <div class="layui-form" lay-filter="layuiadmin-form-admin" style="padding: 20px 30px 1px 0;">
            ...
            <form action="" class="layui-form">
                ...
                <input type="hidden" name="goods_id" id="goods_id" value="<?php echo input('goods_id'); ?>">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <input type="text" name="goods_title" value="<?php echo $goods['title']; ?>" lay-verify="required" autocomplete="off" placeholder="请输入内容" class="layui-input" readonly="readonly">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="uid" id="" lay-verify="required" lay-search>
                            ...
                            <?php if(is_array($user) || $user instanceof \think\Collection || $user instanceof \think\Paginator): if( count($user)==0 ) : echo "" ;else: foreach($user as $key=>$vo): ?>
                                <optgroup label="<?php echo $vo['nickname']; ?>">
                ...
                <!-- <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="nickname" value="" lay-verify="required"  autocomplete="off" placeholder="请输入内容" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="star" value="" lay-verify="required"  autocomplete="off" placeholder="请输入内容" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        ...
                        <textarea placeholder="请输入" lay-verify="required" name="content" class="layui-textarea"></textarea>
...
<script>
    ...
    //表单上传
    fromUpload('form',"<?php echo url('Goods/evaluate_save'); ?>");
