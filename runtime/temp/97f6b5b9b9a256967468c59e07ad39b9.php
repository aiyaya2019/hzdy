<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"/klwl_web/klwl_pj/hzdy.kailly.com/public/../application/admin/view/config/nav.html";i:1563186368;s:73:"/klwl_web/klwl_pj/hzdy.kailly.com/application/admin/view/common/meta.html";i:1552356108;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<script>
    layui.use(['table','form','layer'],function(){
        ...
        var url = "<?php echo url('Config/nav'); ?>";
...
<script type="text/html" id="barDemo">
    <a class="layui-btn layui-btn-xs" lay-event="edit" href="<?php echo url('Config/nav_edit'); ?>?id={{d.id}}">编辑</a>
