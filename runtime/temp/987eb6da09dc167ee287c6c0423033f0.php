        ...
        <div class="layui-form" lay-filter="layuiadmin-form-admin" style="padding: 20px 30px 1px 0;">
            <form action="" class="layui-form">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">会员说明</label>
                    <div class="layui-input-block">
                        <textarea placeholder="请输入会员说明" lay-verify="required" name="grade_desc" class="layui-textarea edit"><?php echo $list['grade_desc']; ?></textarea>
                    </div>
                </div>
...
<script>
    //表单上传
    fromUpload('form',"<?php echo url('User/desc'); ?>");
