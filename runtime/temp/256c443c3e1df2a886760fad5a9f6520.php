            ...
            <div class="layui-row layui-col-space15">
                <div class="layui-col-sm6 layui-col-md12">
                    ...
                    <div class="layui-card layui-fluid">
                        ...
                        <div class=" layui-fluid" style="display: flex;height: 100%">
                            <div class="layui-col-sm2">团单号：<?php echo $data['group_no']; ?></div>
                            <div class="layui-col-sm2">拼团状态：<?php echo $data['group_status_name']; ?></div>
                            <div class="layui-col-sm2">拼团结束：<?php echo $data['add_time']; ?></div>
                            <div class="layui-col-sm2">物流公司：<?php echo (isset($data['logistics_name']) && ($data['logistics_name'] !== '')?$data['logistics_name']:'待发货'); ?></div>
                    ...
                    <div class="layui-card">
                        <table class="layui-table" lay-skin="line" style="margin:0">
                            ...
                            <tr>
                                ...
                                <td style="color:#f00">&yen; <?php echo $data['number'] * $data['goods_price']; ?></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
