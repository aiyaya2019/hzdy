<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"/klwl_web/klwl_pj/hzdy.kailly.com/public/../application/admin/view/bargain/delivery.html";i:1563208558;s:73:"/klwl_web/klwl_pj/hzdy.kailly.com/application/admin/view/common/meta.html";i:1552356108;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<script>
    ...
    // 表单提交
    fromUpload('form',"<?php echo url('Bargain/delivery'); ?>",function(data){
        if(data.code == 200){
